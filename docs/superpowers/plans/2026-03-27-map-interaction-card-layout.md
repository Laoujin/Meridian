...
Run: `cd /mnt/c/users/woute/Dropbox/Personal/Programming/UnixCode/projects/caro/app && bun add -d vitest`
...
Run: `cd /mnt/c/users/woute/Dropbox/Personal/Programming/UnixCode/projects/caro/app && bun test`
...
Run: `cd /mnt/c/users/woute/Dropbox/Personal/Programming/UnixCode/projects/caro/app && bunx tsc --noEmit 2>&1 | head -20`
...
Run: `cd /mnt/c/users/woute/Dropbox/Personal/Programming/UnixCode/projects/caro/app && bunx tsc --noEmit 2>&1 | grep CardOverlay`
...
Run: `cd /mnt/c/users/woute/Dropbox/Personal/Programming/UnixCode/projects/caro/app && bunx tsc --noEmit 2>&1 | grep TravelLine`
...
Run: `cd /mnt/c/users/woute/Dropbox/Personal/Programming/UnixCode/projects/caro/app && bun add react-markdown`
...
Run: `cd /mnt/c/users/woute/Dropbox/Personal/Programming/UnixCode/projects/caro/app && bunx tsc --noEmit`
...
Run: `cd /mnt/c/users/woute/Dropbox/Personal/Programming/UnixCode/projects/caro/app && bun dev`
...
Run: `cd /mnt/c/users/woute/Dropbox/Personal/Programming/UnixCode/projects/caro/app && bun lint`
