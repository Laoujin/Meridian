...
test('Beleuvenissen → Operatie Demo transition keeps dots visible', async ({ page }) => {
  page.on('console', msg => {
  ...
  const indices = await page.evaluate(() => {
    const scroll = (window as any).__scrollState;
    // Scan section IDs to find which index Beleuvenissen and Operatie Demo are
  ...
  // Beleuvenissen is memory index ~7, Operatie Demo ~8
  ...
  // Beleuvenissen = 2024-08-09, Operatie Demo = 2024-08-26
